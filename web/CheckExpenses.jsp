                        ...
                        <table id="customers">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td  ><%=rs.getString("expenses_spent")%></td>
                                    <td  ><%=rs.getString("expenses_recived")%></td>
                                    <td ><%=rs.getString("expenses_balance")%></td>
                                    <%                                        }
                                        } catch (Exception ex) {
                                            ex.printStackTrace();
                                        }
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td  ><%=rs1.getString("wardno")%></td>
                                    <td  ><%=rs1.getString("spentfor")%></td>
