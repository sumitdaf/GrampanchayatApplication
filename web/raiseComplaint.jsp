<%-- 
    Document   : WaterPayment
    Created on : 12 May, 2022, 3:36:37 AM
    Author     : Beast
--%>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" rows="7" id="comment" name="complaint" placeholder="Message" ></textarea>
                                                    </div><!--/.form-group-->
                                                </div><!--/.col-->
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-6">
                                                     <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="file" name="compic">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="single-contact-btn">
                                                        <button  class="contact-btn" type="submit">Post</button>
                                                    </div><!--/.single-single-contact-btn-->
                                                </div><!--/.col-->
                                            </div>
                                        </form>
