                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td ><%=rs.getString("statuss")%></td>
                                     <td><a href="UserActivate?id=<%=rs.getString("id")%>"  class="btn btn-success" style="color: white">&nbsp;Activate</a>&nbsp;&nbsp;
                                            <a href="UserReject?id=<%=rs.getString("id")%>"   class="btn btn-danger" style="color: white">&nbsp;Deactivate</a></td>
                                    <%                                        }
                                        } catch (Exception ex) {
                                            ex.printStackTrace();
                                        }
