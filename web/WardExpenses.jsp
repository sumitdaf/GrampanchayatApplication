            ...
            <div class="container">
                <div class="we-do-details">
                    <div class="section-header text-center">
                        ...
                        <h2>Ward Maintenance and Expenses</h2>
                    </div>
                        <div class="col-sm-offset-3 col-sm-6" style="background-color: #a6a3f7">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="custom-select" style="width:260px; height: 50px" name="wardno" id="email">
                                                        <%
                                                            ...
                                                            try {
                                                                ResultSet rs1 = st.executeQuery("Select * from ward_details");
                                                                while (rs1.next()) {
                                                        %>
                                                        <option selected="" value="<%=rs1.getString("wardno")%>"><%=rs1.getString("wardno")%></option>
                                                        <%                                        }
                                                            } catch (Exception ex) {
                                                                ex.printStackTrace();
                                                            }
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="phone" placeholder="Spent For" name="spentfor">
                                                </div><!--/.form-group-->
                                            </div><!--/.col-->
                                            <div class="col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    <label>Amount</label>
                                                    <input type="text" class="form-control" id="phone" placeholder="Amount" name="amount">
                                                </div><!--/.form-group-->
                                            </div><!--/.col-->
                                        </div>
                                        <div class="row">
                        ...
                        <table id="customers">
                            ...
                            <tbody>
                                <%                                    Statement st1 = con.createStatement();
                                    try {
                                        ResultSet rs = st1.executeQuery("Select * from ward_details");
                                        while (rs.next()) {
                                %>
                                <tr>
                                    ...
                                    <td ><%=rs.getString("expenseall")%></td>
                                    <td ><%=rs.getString("exp_spent")%></td>
                                    <td ><%=rs.getString("exp_bal")%></td>
                                    <%                                        }
                                        } catch (Exception ex) {
                                            ex.printStackTrace();
                                        }
