            ...
            <div class="container">
                <div class="we-do-details" style="background-color: #a6a3f7">
                    ...
                    <%
                        ...
                        try {
                            ResultSet rs = st.executeQuery("Select * from water_con where id='" + id + "'");
                            while (rs.next()) {
                    %>
                            ...
                            <div class="col-sm-offset-3 col-sm-6">
                                <div class="single-contact-box">
                                    <div class="contact-form">
                                        <form action="ProcessWaterPipe" method="post" >
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <img src="water_proof.jsp?id=<%=rs.getString("id")%>" height="200" width="200">
                                                    </div><!--/.form-group-->
                                                </div><!--/.col-->
                                            </div>
                                            <p>==========================================================================</p>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="single-contact-btn">
                                                    <form action="WaterSetup_reject.jsp" method="post">
                                                        <input type="hidden" value="<%=rs.getString("id")%>" name="id">
