<%-- 
    Document   : WaterPipeReq
    Created on : 12 May, 2022, 12:32:16 AM
    Author     : Beast
--%>
            ...
            <div class="container">
                <div class="we-do-details" style="background-color: #a6a3f7">
                    ...
                    <div class="section-header text-center">
                        <h2>New Water Pipe Connection Request</h2>
                    </div><!--/.section-header-->
                            ...
                            <div class="col-sm-offset-3 col-sm-6">
                                <div class="single-contact-box">
                                    <div class="contact-form">
                                        <form action="water_req" method="post" enctype="multipart/form-data">
                                            <div class="row">
