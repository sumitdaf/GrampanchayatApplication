<%-- 
    Document   : NewElectricityEntry
    Created on : 11 May, 2022, 5:09:30 PM
    Author     : Beast
--%>
            ...
            <div class="container">
                <div class="we-do-details">
                    <div class="section-header text-center">
                        <h2>New Electricity Connection Details</h2>
                        <br>
                        <table id="customers">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <%
                                    ...
                                    try {
                                        ResultSet rs = st.executeQuery("Select * from electricity_con where statuss='" + uid + "'");
                                        while (rs.next()) {
                                %>
                                <tr>
                                    ...
                                    <td ><a class="btn-success" href="ProcessElectric.jsp?id=<%=rs.getString("id")%>">Process</a></td>
                                    <%                                        }
                                        } catch (Exception ex) {
                                            ex.printStackTrace();
                                        }
