            ...
            <div class="container">
                <div class="we-do-details">
                    <div class="section-header text-center">
                        <h2>Water Pipe Request Details</h2>
                        <br>
                        <table id="customers">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <%
                                    ...
                                    try {
                                        ResultSet rs = st.executeQuery("Select * from water_con where statuss='" + uid + "'");
                                        while (rs.next()) {
                                %>
                                <tr>
                                    ...
                                    <td ><a class="btn-success" href="ProcessWaterPipe.jsp?id=<%=rs.getString("id")%>">Process</a></td>
                                    <%                                        }
                                        } catch (Exception ex) {
                                            ex.printStackTrace();
                                        }
