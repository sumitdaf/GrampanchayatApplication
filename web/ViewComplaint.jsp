                        ...
                        <table id="customers">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td ><%=rs.getString("uwardno")%></td>
                                    <td ><textarea readonly="" disabled="" ><%=rs.getString("complaint")%></textarea></td>
                                    <td ><img src="comlaintpic.jsp?id=<%=rs.getString("id")%>" height="200" width="200"></td>
